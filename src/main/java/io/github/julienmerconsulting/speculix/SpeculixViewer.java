package io.github.julienmerconsulting.speculix;

import io.github.julienmerconsulting.speculix.client.SpeculixClient;
...
import static io.github.julienmerconsulting.speculix.client.rendering.ColorDepth.*;
...
public class SpeculixViewer extends JFrame {

    private SpeculixConfig config;
    private SpeculixClient client;
    ...
    private SpeculixViewer() {
        initUI();
    }

    private void initUI() {
        setTitle("Speculix VNC");
        setSize(800, 600);
    ...
    private void initialiseSpeculixClient() {
        config = new SpeculixConfig();
        ...
        client = new SpeculixClient(config);
    }
    ...
    public static void main(String[] args) {
        invokeLater(() -> {
            SpeculixViewer viewer = new SpeculixViewer();
