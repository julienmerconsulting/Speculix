...
import io.github.julienmerconsulting.speculix.protocol.handshaking.Handshaker;
import io.github.julienmerconsulting.speculix.protocol.initialization.Initializer;
import io.github.julienmerconsulting.speculix.utils.KeySyms;
...
public class SpeculixClient {

    private final Handshaker handshaker;
    private final Initializer initializer;

    private final SpeculixConfig config;
     ...
     */
    public SpeculixClient(SpeculixConfig config) {
        this.config = config;
